				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="笔记内容" prop="bijineirong">
							<editor :value="form.bijineirong" placeholder="请输入笔记内容" :readonly="!isAdd||disabledForm.bijineirong?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'bijineirong')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.bijineirong = res.data.data.bijineirong?(res.data.data.bijineirong.replace(reg,'../../../cl9362465/file')):'';
